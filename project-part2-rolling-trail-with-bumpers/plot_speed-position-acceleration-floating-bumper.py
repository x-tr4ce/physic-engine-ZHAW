...
z_bumper = df['z_bumper'].values  # Position des Bumpers [m]
vz_bumper = df['vz_bumper'].values     # Geschwindigkeit des Bumpers [m/s]
...
# Position
axs[0].plot(t, z, label='Wagen')
axs[0].plot(t, z_bumper, label='Bumper')
...
# Geschwindigkeit
axs[1].plot(t, vz, label='Wagen')
axs[1].plot(t, vz_bumper, label='Bumper')
