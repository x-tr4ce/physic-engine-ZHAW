...
# Position
axs[0].plot(t, z)
axs[0].set_title('Position des Wagens über der Zeit (Ohne Feder)')
...
# Geschwindigkeit
axs[1].plot(t, vz)
axs[1].set_title('Geschwindigkeit des Wagens über der Zeit (Ohne Feder)')
...
# Beschleunigung
axs[2].plot(t, az)
axs[2].set_title('Beschleunigung des Wagens über der Zeit (Ohne Feder)')
